...
CACHEOPS_REDIS = os.getenv(
    "NAUTOBOT_CACHEOPS_REDIS",
    f"{redis_protocol}://:{cache_ops_pwd}@{cache_ops_host}:{cache_ops_port}/1",
)
...
SECRET_KEY = os.getenv(
    "NAUTOBOT_SECRET_KEY", "v8b0_x=$*xk#(qyy#0^&z6a$l=3#i8ohm5guu%yf@dtxh3rub%"
)
...
CACHEOPS_DEFAULTS = {
    "timeout": int(os.getenv("NAUTOBOT_CACHEOPS_TIMEOUT", 900))
}
...
PLUGINS_CONFIG = {
    ...
    "nautobot_device_onboarding": {
        ...
        "platform_map": {},  # netmiko mapping
        "onboarding_extensions_map": {},  # napalm mapping
    },
    "nautobot_ssot": {
        "hide_example_jobs": False,  # defaults to False if unspecified
    },
    "welcome_wizard": {"enable_devicetype-library": True},
}
